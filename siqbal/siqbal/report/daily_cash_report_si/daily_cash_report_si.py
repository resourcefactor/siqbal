...
def validate_filters(filters, account_details):
    ...
    if not filters.get("account"):
        frappe.throw(
            _("{0} Filter is mandatory").format(
                frappe.bold(_("Account"))
            )
        )
...
def get_result(filters, account_details):
    ...
    # Store the final result in a new list to avoid modifying `result` during iteration
    final_result = []
...
def get_columns(filters):
    ...
    columns.extend(
        [
            ...
            {
                "label": _("Description (P.I)"),
                "fieldname": "description_pi",
                "fieldtype": "Data",
                "width": 180,
            },
            {
                "label": _("Account Head (P.I)"),
                "fieldname": "account_head_pi",
                "fieldtype": "Link",
                "options": "Account",
                "width": 100,
            },
            {
                "label": _("Item Amount (P.I)"),
                "fieldname": "item_amount_pi",
                "fieldtype": "Float",
                "width": 100,
            },
